...
mod_03_patients_by_gender_and_age_band_chart_ui <- function(id) {
  ...
  tagList(
    ...
    p(
      tags$b("Two thirds"), " of older care home patients are ", tags$b("female"), "(66%) compared to around",
      "half (53%) in those aged 65+ years receiving prescriptions in general."
    ),
    p(
      tags$b("One quarter"), " of care home patients in 2020/21 are", tags$b("female aged 90."),
...
#' 03_patients_by_gender_and_age_band_chart Server Functions
#'
#' @noRd
mod_03_patients_by_gender_and_age_band_chart_server <- function(id) {
    ...
    output$patients_by_gender_and_age_band_chart <- highcharter::renderHighchart({
      highcharter::highchart() %>%
        ...
        highcharter::hc_title(
          text = "Age band and gender of estimated care home patients in England (2020/21)"
        ) %>%
...
# mod_03_patients_by_gender_and_age_band_chart_ui("03_patients_by_gender_and_age_band_chart_ui_1")

## To be copied in the server
# mod_03_patients_by_gender_and_age_band_chart_server("03_patients_by_gender_and_age_band_chart_ui_1")
