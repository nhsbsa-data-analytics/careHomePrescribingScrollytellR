...
AMENDMENTS:
    ...
    26-11-2021  :   Steven Buckley  :   Adjusted code to reflect the changes to classifications in the matching scripts
...
DESCRIPTION:
    ...
    This dataset will show each patient address identified as a care home along with:
        ...
        +   the details of any AddressBase/CQC property matched to
...
OUTPUTS:
        INT615_RESULTS_VALIDATION   :   Output dataset showing match results at address level for verification checking
...
left join   INT615_MATCH                m   on  ms.ADDRESS_RECORD_ID    =   m.ADDRESS_RECORD_ID
                                            and m.CAREHOME_FLAG = 1 --only pull back the AddressBase/CQC information for matches to care homes
;
